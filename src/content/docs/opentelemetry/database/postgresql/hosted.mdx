...
2. Update the config path to point to your new `postgresql-config.yaml` file:
...
3. Validate the NRDOT Collector configuration to ensure it's correctly formatted and will work properly:
